...
/**
 Specialized subclass of BCKCode to represent a Code128 code
 
 Known issues:
 
 1. Length may not always be optimal. There is some length optimisation done, but this is not covering all cases. But even when most compact barcode is not generated, this will still be valid.
 ...
 */
@interface BCKCode128Code : BCKCode
