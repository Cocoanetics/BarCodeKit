...
@interface BCKISBNCodeTest : XCTestCase
...
- (void)testEncodeValid
{
	...
	XCTAssertNotNil(code, @"Should be able to encode ISBN13 code with check digit");
	XCTAssertEqualObjects(code.titleText, @"ISBN 978-3-16-148410-0", @"ISBN13 code with check digit incorrect title text");
	XCTAssertEqualObjects(code.content, @"9783161484100", @"ISBN13 code with check digit encoded incorrectly");
	XCTAssertNil(error, @"NSError should be nil");
	...
	XCTAssertNotNil(code, @"Should be able to encode ISBN13 code without check digit");
	XCTAssertEqualObjects(code.titleText, @"ISBN 978-3-16-148410-0", @"ISBN13 code without check digit incorrect title text");
	XCTAssertEqualObjects(code.content, @"9783161484100", @"ISBN13 code without check digit encoded incorrectly");
	XCTAssertNil(error, @"NSError should be nil");
	...
	XCTAssertNotNil(code, @"Should be able to encode ISBN10 code with check digit");
	XCTAssertEqualObjects(code.titleText, @"ISBN 3-16-148410-X", @"ISBN10 code with check digit incorrect title text");
	XCTAssertEqualObjects(code.content, @"9783161484100", @"ISBN10 code with check digit encoded incorrectly");
	XCTAssertNil(error, @"NSError should be nil");
	...
	XCTAssertNotNil(code, @"Should be able to encode ISBN10 code without check digit");
	XCTAssertEqualObjects(code.titleText, @"ISBN 3-16-148410-X", @"ISBN10 code without check digit incorrect title text");
	XCTAssertEqualObjects(code.content, @"9783161484100", @"ISBN10 code without check digit encoded incorrectly");
	XCTAssertNil(error, @"NSError should be nil");
}
...
- (void)testISBNCheckDigits
{
	...
	// ISBN13 with check digit
	code = [[BCKISBNCode alloc] initWithPrefix:@"978" andRegistrationGroup:@"3" andRegistrant:@"16" andPublication:@"148410" andCheckDigit:@"0" error:&error];
	XCTAssertEqualObjects(code.content, @"9783161484100", @"ISBN13 with check digit should generate correct check digit");
	
	// ISBN13 without check digit
	code = [[BCKISBNCode alloc] initWithPrefix:@"978" andRegistrationGroup:@"3" andRegistrant:@"16" andPublication:@"148410" error:&error];
	XCTAssertEqualObjects(code.content, @"9783161484100", @"ISBN13 without check digit should generate correct check digit");
	...
	XCTAssertEqualObjects(code.content, @"9780306406157", @"ISBN10 with check digit should generate correct check digit");
	
	// ISBN10 without check digit
	code = [[BCKISBNCode alloc] initWithPrefix:nil andRegistrationGroup:@"0" andRegistrant:@"306" andPublication:@"40615" error:&error];
	XCTAssertEqualObjects(code.content, @"9780306406157", @"ISBN10 without check digit should generate correct check digit");
}
...
- (void)testEncodeUsingValidString
{
	...
	XCTAssertEqualObjects(code.content, @"9783161484100", @"Should be able to initialise ISBN13 with string");
	XCTAssertEqualObjects(code.titleText, @"ISBN 978-3-16-148410-0", @"Should be able to initialise title text for ISBN13 with string");
	
	// ISBN10 check digit = EAN check digit
	code = [[BCKISBNCode alloc] initWithContent:@"3-16-148410-X" error:&error];
	XCTAssertEqualObjects(code.content, @"9783161484100", @"Should be able to initialise ISBN10 with string");
	XCTAssertEqualObjects(code.titleText, @"ISBN 3-16-148410-X", @"Should be able to initialise title text for ISBN10 with string");
	
	// ISBN10 check digit != EAN check digit
	code = [[BCKISBNCode alloc] initWithContent:@"81-7525-766-0" error:&error];
	XCTAssertEqualObjects(code.content, @"9788175257665", @"Should be able to initialise ISBN10 with string");
	XCTAssertEqualObjects(code.titleText, @"ISBN 81-7525-766-0", @"Should be able to initialise title text for ISBN10 with string");
...
- (void)testEncodeUsingInvalidString
{
	...
	XCTAssertNil(code, @"Should not be able to include 'X' in ISBN13 string");
	
	code = [[BCKISBNCode alloc] initWithContent:@"978--316-148410-0" error:&error];
	XCTAssertNil(code, @"Should not be able to include 'empty' elements in ISBN13 string");
	
	code = [[BCKISBNCode alloc] initWithContent:@"316--148410-X" error:&error];
	XCTAssertNil(code, @"Should not be able to include 'empty' elements in ISBN10 string");
	
	code = [[BCKISBNCode alloc] initWithContent:@"316-148410--X" error:&error];
	XCTAssertNil(code, @"Should not be able to include 'empty' elements in ISBN10 string");
	
	code = [[BCKISBNCode alloc] initWithContent:@"3-16-48410-X" error:&error];
	XCTAssertNil(code, @"Should not be able to encode ISBN10 strings with less than 10 characters");
	
	code = [[BCKISBNCode alloc] initWithContent:@"978-3-16-48410-0" error:&error];
	XCTAssertNil(code, @"Should not be able to encode ISBN13 strings with less than 13 characters");
...
- (void)testEncodeUsingInvalidRegistrant
{
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: too short");
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: too long");
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: 2");
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: 55");
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: 890");
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: 9500");
...
- (void)testEncodeUsingInvalidRegistrationGroup
{
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: 6");
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: 95");
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: 990");
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: 9999");
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: 9");
	...
	XCTAssertNil(code, @"Should not be able to encode invalid Registation Group: 12");
}
