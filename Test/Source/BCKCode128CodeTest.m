...
@interface BCKCode128CodeTest : XCTestCase
...
- (void)testUnsupportedCharacterGivesMeaningfulError
{
	...
	XCTAssertNil(code, @"Should have not created code with unsupported character");
	XCTAssertNotNil(error, @"Should have assigned error");
}
